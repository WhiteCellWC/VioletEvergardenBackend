        ...
        <template #content>
            <div class="px-4 py-2 bg-gray-600">
                <div class="flex items-center justify-between">
                    ...
                    <Link :href="route('delivery-options.create')"
                    ...
                    <span>Create Delivery Option</span>
                    </Link>
                </div>
            </div>

            <div class="p-4">
                <Table :resource="props.deliveryOptions" :columns="columns" :windowSize="1">
                    <template #actions="{ row }">
                        <Link :href="route('delivery-options.edit', row.id)">
                        <FontAwesomeIcon :icon="['fas', 'pen-to-square']" class="text-blue-500 me-2" />
                        </Link>
                        <Link :href="route('delivery-options.destroy', row.id)" method="delete" class="">
