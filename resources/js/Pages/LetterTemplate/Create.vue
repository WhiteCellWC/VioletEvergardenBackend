...
const form = useForm({
    ...
    envelope_type_id: '',
    wax_seal_type_id: '',
    letter_type_ids: '' // Keep as string for the dropdown
})
...
// Handlers
const submit = () => {
    // Convert letter_type_ids to array before sending
    const formData = {
        ...form.data(),
        letter_type_ids: form.letter_type_ids ? [form.letter_type_ids] : []
    };

    form.transform(() => formData).post(route('letter-templates.store'));
}
            ...
            <form @submit.prevent="submit" class="p-8 flex flex-col w-1/2 gap-6">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <Dropdown v-model="form.paper_type_id" :fetchRoute="route('api.v1.paper-types.index')"
                        :valueKey="'id'" :labelKey="'name'" placeholder="Select Paper Type" :allowSearch="true" />
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <Dropdown v-model="form.fragrance_type_id" :fetchRoute="route('api.v1.fragrance-types.index')"
                        :valueKey="'id'" :labelKey="'name'" placeholder="Select Fragrance Type" :allowSearch="true" />
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <Dropdown v-model="form.envelope_type_id" :fetchRoute="route('api.v1.envelope-types.index')"
                        :valueKey="'id'" :labelKey="'name'" placeholder="Select Envelope Type" :allowSearch="true"
                        :openUpwards="true" />
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <Dropdown v-model="form.wax_seal_type_id" :fetchRoute="route('api.v1.wax-seal-types.index')"
                        :valueKey="'id'" :labelKey="'name'" placeholder="Select Wax Seal Type" :allowSearch="true"
                        :openUpwards="true" />
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <Dropdown v-model="form.letter_type_ids" :fetchRoute="route('api.v1.letter-types.index')"
                        :valueKey="'id'" :labelKey="'name'" placeholder="Select Letter Type" :allowSearch="true"
                        :openUpwards="true" />
                </div>
